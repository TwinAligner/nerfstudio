...
class VanillaPipeline(Pipeline):
    ...
    def __init__(
        ...
        if (
            ...
            if "points3D_partidx" in self.datamanager.train_dataparser_outputs.metadata:
                pts_partidx = self.datamanager.train_dataparser_outputs.metadata["points3D_partidx"]
                seed_pts = (pts, pts_rgb, pts_partidx)
            else:
