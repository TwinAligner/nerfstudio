...
from nerfstudio.data.dataparsers.part_dataparser import PartDataParserConfig
...
dataparsers = {
    ...
    "part-data": PartDataParserConfig(),
    "twopart-blend-data": TwoPartBlendDataParserConfig(),
    "splatfacto-art-data": SplatfactoArtDataParserConfig(),
}
