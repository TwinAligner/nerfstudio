...
class NGPModel(Model):
    ...
    def populate_modules(self):
        ...
        # Occupancy Grid.
        self.occupancy_grid = nerfacc_nerfstudio.OccGridEstimator(
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        # accumulation
        packed_info = nerfacc_nerfstudio.pack_info(ray_indices, num_rays)
        weights = nerfacc_nerfstudio.render_weight_from_density(
